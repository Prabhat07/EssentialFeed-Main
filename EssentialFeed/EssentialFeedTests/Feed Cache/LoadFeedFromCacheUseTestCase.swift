...
class LoadFeedFromCacheUseTestCase: XCTestCase {
    ...
    private func expect(_ sut: LocalFeedLoader, completeWith expectedResult: Swift.Result<[FeedImage], Error>, when action: () -> (), file: StaticString = #filePath, line: UInt = #line) {
