...
//
//  Created by Prabhat Tiwari on 08/08/21.
//
...
class EssentialFeedCacheIntegrationTests: XCTestCase {
    ...
    func test_load_deliversItemOnSaveOnSeperateInstance() {
    ...
    func test_save_overrideItemOnSaveOnSeperateInstance() {
    ...
    private func deleteSoteArtifacts() {
